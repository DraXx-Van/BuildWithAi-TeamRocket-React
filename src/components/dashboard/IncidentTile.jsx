...
export default function IncidentTile({ incident }) {
  ...
  const { selectedIncidentId, setSelectedIncidentId, setFocusedIncidentId } = useIncidentStore();
    ...
    <>
      ...
      >
        ...
        <div style={{ padding: 20, paddingLeft: 24 }}>
          {/* Top row */}
          <div className="flex items-center justify-between" style={{ marginBottom: 12, flexWrap: 'wrap', gap: 12 }}>
            ...
            <div className="flex items-center gap-8">
              {incident.assignedTo && (
                <span 
                  ...
                  style={{ cursor: 'pointer', padding: '2px 8px', background: 'rgba(16,185,129,0.1)', border: '1px solid rgba(16,185,129,0.3)', borderRadius: 4, fontFamily: 'var(--font-mono)', fontSize: 9, fontWeight: 700, color: 'var(--color-success)' }}
                >
                  ▶ {incident.assignedTo}
                </span>
              )}
          ...
          {/* Title */}
          <div style={{ fontFamily: 'var(--font-display)', fontSize: 14, fontWeight: 700, color: 'var(--color-text-hi)', marginBottom: 6, letterSpacing: 0.5 }}>
