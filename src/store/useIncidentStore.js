...
import {
  ...
  seedStaffIfEmpty, streamLiveIncidents, streamEvacuationStatus, triggerEvacuation
...
const useIncidentStore = create((set, get) => ({
  ...
  init: async () => {
    ...
    set({ unsubscribeLiveIncidents: unsubscribeLive, unsubscribeEvacuation: unsubscribeEvac });
  },
